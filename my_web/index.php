<?php
session_start();
if (@$_SESSION["username"] == "" && @$_SESSION["login"] != true) {
  echo "<script>
  location='login.php'
  </script>";
}
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item halaman" halaman="profile" href="#">Profile</a></li>
                <!-- <li><a class="dropdown-item" href="#">Another action</a></li> -->
                <li>
                  <hr class="dropdown-divider">
                </li>
                <li><a class="dropdown-item" href="javascript:logout('controller/logout.php')">Logout</a></li>
              </ul>
            </li>
            <li class="nav-item">
